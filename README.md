...
- **Advanced Python Syntax:** Constants, Type Hints, Unpacking, list & dictionary comprehensions, Generators, Iterators and `global`, `map`, `filter`, `enumerate`, `argparse`, `yield`.
