...
- **Advanced Python Syntax:** global, constants, type hints, argparse, unpacking, list & dictionary comprehensions, map, filter, enumerate, generators, iterators and yield.
