...
- **Advanced Python Syntax:** Constants, Type Hints, Docstrings, Unpacking, list & dictionary comprehensions, Generators, Iterators and `global`, `map`, `filter`, `enumerate`, `argparse`, `yield`.
